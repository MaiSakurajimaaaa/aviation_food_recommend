  ...
  <view class="submit app-card">
    <form @submit="submit">
      ...
      <view class="item">
        ...
        <input class="item_input app-input" placeholder="请输入手机号" v-model="user.phone" />
      </view>
      <button form-type="submit" class="submit_btn app-btn">确认修改</button>
    </form>
  </view>
  </view>
</template>
