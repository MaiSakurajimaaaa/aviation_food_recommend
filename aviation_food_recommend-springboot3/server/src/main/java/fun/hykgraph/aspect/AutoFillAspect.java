package fun.hykgraph.aspect;

import fun.hykgraph.annotation.AutoFill;
import fun.hykgraph.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点表达式，封装成一个小方法
     */
    @Pointcut("execution(* fun.hykgraph.mapper.*.*(..)) && @annotation(fun.hykgraph.annotation.AutoFill)")
